...
function OtherSkills() {
	...
	async function processData(data: FormData) {
		...
		dispatch(setCurrentStep(currentStep - 5));
			...
			<CardContent>
				<form onSubmit={handleSubmit(processData)}>
					<div className="grid w-full items-center gap-4">
						...
						<div className="flex flex-row space-x-4">
							<div className="flex flex-col space-y-1.5 w-full">
								...
								<Textarea
									id="occupation"
									placeholder="Escribe una breve descripcion de la habilidad"
					...
					<div className="flex justify-between mt-3">
						...
						<Button
							variant={'ghost'}
							className="bg-accent-green text-custom-mate hover:bg-base-900 hover:text-custom-mate flex items-center gap-2 font-bold"
							type="submit"
						>
							Confirmar y Subir
						</Button>
