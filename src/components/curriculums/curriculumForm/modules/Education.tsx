	...
	return (
		<Card className="w-[350px] xl:w-[650px] md:w-[450px] lg:w-[500px] bg-base-800 border-none h-full">
			<CardHeader>
				...
				<CardDescription className="text-2xl">Educacion</CardDescription>
			</CardHeader>
			<CardContent>
					...
					<div className="grid w-full items-center gap-4">
						<div className="flex flex-row space-x-4">
							<div className="flex flex-col space-y-1.5 w-full">
								...
								<Input
									id="name"
									placeholder="Escribe el titulo de la carrera"
						...
						<div className="flex flex-row space-x-4">
							<div className="flex flex-col space-y-1.5 w-full">
								...
								<Textarea
									id="occupation"
									placeholder="Escribe una breve descripcion de la carrrera"
